...
class A2(object):
    ...
    def confusion_matrix(self):
        ...
        conf_matrix = conf_matrix.rename(index={0: "Not Smiling", 1: "Smiling"},
                                         columns={0: "Not Smiling", 1: "Smiling"})
...
if __name__ == "__main__":
    from config import *
    data_train, data_val, data_test = data_preprocessing('celeba', 'smiling')
    model_A2 = A2(data_train, data_val, data_test, config.model, config.gap, config.init, config.num_epochs, config.freeze)
