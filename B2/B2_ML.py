...
class B2(object):
    ...
    def test(self):
        ...
        print(classification_report(self.test_labels, self.pred, target_names=['0', '1', '2', '3', '4']))
...
if __name__ == "__main__":
    ...
    model_B1 = B2(data_train, data_val, data_test, config.model)
    acc_B1_train = model_B1.fit()
