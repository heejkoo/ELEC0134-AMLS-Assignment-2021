...
from models import build_convnet
...
class B2(object):
    ...
    def __init__(self, train_set, val_set, test_set, model, gap, init, num_epochs):
...
if __name__ == "__main__":
    from config import *
    data_train, data_val, data_test = data_preprocessing('cartoon_set', 'eye_color')
    model_B2 = B2(data_train, data_val, data_test, config.model, config.gap, config.init, config.num_epochs)
