...
if __name__ == "__main__":
    ...
    data_train, data_val, data_test = data_preprocessing('celeba', 'gender')
    model_A1 = A1(data_train, data_val, data_test, config.model, config.gap, config.init, config.num_epochs, config.freeze)
